...
{
    public class VerkleBlockProducerEnvFactory
    {
        ...
        public VerkleBlockProducerEnvFactory(
        ...
        public virtual BlockProducerEnv Create(ITxSource? additionalTxSource = null)
        {
            ...
            VerkleReadOnlyTxProcessingEnv txProcessingEnv =
                CreateReadonlyTxProcessingEnv(_stateProvider, readOnlyDbProvider, readOnlyBlockTree);
        ...
        protected virtual VerkleReadOnlyTxProcessingEnv CreateReadonlyTxProcessingEnv(VerkleStateProvider stateProvider, ReadOnlyDbProvider readOnlyDbProvider, ReadOnlyBlockTree readOnlyBlockTree) => 
            new(readOnlyDbProvider, stateProvider, readOnlyBlockTree, _specProvider, _logManager);
        ...
        protected virtual BlockProcessor CreateBlockProcessor(VerkleReadOnlyTxProcessingEnv readOnlyTxProcessingEnv,
            ISpecProvider specProvider,
            IBlockValidator blockValidator,
            IRewardCalculatorSource rewardCalculatorSource,
            IReceiptStorage receiptStorage,
