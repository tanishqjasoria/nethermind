...
{
    public class VerkleBlockProducerEnvFactory : IBlockProducerEnvFactory
    {
        ...
        protected virtual VerkleReadOnlyTxProcessingEnv CreateReadonlyTxProcessingEnv(ReadOnlyDbProvider readOnlyDbProvider, ReadOnlyBlockTree readOnlyBlockTree) => 
            new(readOnlyDbProvider, _stateProvider, readOnlyBlockTree, _specProvider, _logManager);

        protected virtual ITxSource CreateTxSourceForProducer(
            ITxSource? additionalTxSource, 
            VerkleReadOnlyTxProcessingEnv processingEnv, 
            ITxPool txPool, 
            IMiningConfig miningConfig, 
            ITransactionComparerProvider transactionComparerProvider, 
            ILogManager logManager)
