...
{
    public class VerkleReadOnlyTxProcessingEnv : IReadOnlyTxProcessorSourceExt
    {
        ...
        public VerkleReadOnlyTxProcessingEnv(
            ...
            IVerkleReadOnlyVerkleTrieStore? readOnlyTrieStore,
            ...
            ILogManager? logManager)
        {
            ...
            StateReader = new VerkleStateReader(readOnlyTrieStore, _codeDb, logManager);
            VerkleStateProvider stateReader = new (readOnlyTrieStore, logManager, _codeDb);
            StateProvider = stateReader;
            StorageProvider = new VerkleStorageProvider(stateReader, logManager);
