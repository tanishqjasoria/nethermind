...
namespace Nethermind.Blockchain.Processing
{
    ...
    /// Not thread safe.
    /// </summary>
    public class VerkleReadOnlyChainProcessingEnv : IDisposable
    {
        private readonly VerkleReadOnlyTxProcessingEnv _txEnv;
        ...
        public VerkleReadOnlyChainProcessingEnv(
            VerkleReadOnlyTxProcessingEnv txEnv,
            ...
            IBlockProcessor.IBlockTransactionsExecutor? blockTransactionsExecutor = null)
        {
            ...
            ChainProcessor = new VerkleOneTimeChainProcessor(trieStore, _blockProcessingQueue);
        }
