...
namespace Nethermind.AuRa.Test.Contract
{
    public class VerkleTxPriorityContractTests
    {
        ...
        {
            using TxPermissionContractBlockchain chain = await VerkleTestContractBlockchain.ForTest<TxPermissionContractBlockchain, VerkleTxPriorityContractTests>();
        ...
        {
            using TxPermissionContractBlockchainWithBlocks chain = await VerkleTestContractBlockchain.ForTest<TxPermissionContractBlockchainWithBlocks, VerkleTxPriorityContractTests>();
            IEnumerable<Address> whiteList = chain.TxPriorityContract.SendersWhitelist.GetAllItemsFromBlock(chain.BlockTree.Head.Header);
        ...
        public async Task whitelist_should_return_correctly_with_local_storage([Values(true, false)] bool fileFirst)
        {
            using TxPermissionContractBlockchainWithBlocksAndLocalData chain = fileFirst 
                ? await VerkleTestContractBlockchain.ForTest<TxPermissionContractBlockchainWithBlocksAndLocalDataBeforeStart, VerkleTxPriorityContractTests>()
                : await VerkleTestContractBlockchain.ForTest<TxPermissionContractBlockchainWithBlocksAndLocalData, VerkleTxPriorityContractTests>();
        ...
        public class TxPermissionContractBlockchain : VerkleTestContractBlockchain
        {
            ...
            protected override TxPoolTxSource CreateTxPoolTxSource()
            {
                ...
                TxPriorityContract = new TxPriorityContract(AbiEncoder.Instance, TestItem.AddressA, 
                    new VerkleReadOnlyTxProcessingEnv(DbProvider, State, BlockTree, SpecProvider, LimboLogs.Instance));
