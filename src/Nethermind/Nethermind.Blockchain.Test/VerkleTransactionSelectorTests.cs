...
{
    public class VerkleTransactionSelectorTests
    {
        public static IEnumerable ProperVerkleTransactionsSelectedTestCases
        {
            get
            {
                ProperVerkleTransactionsSelectedTestCase allTransactionsSelected = ProperVerkleTransactionsSelectedTestCase.Default;
                ...
                ProperVerkleTransactionsSelectedTestCase twoTransactionSelectedDueToLackOfSenderAddress =
                    ProperVerkleTransactionsSelectedTestCase.Default;
        ...
        public static IEnumerable Eip1559LegacyTransactionTestCases
        {
            get
            {
                ProperVerkleTransactionsSelectedTestCase allTransactionsSelected = ProperVerkleTransactionsSelectedTestCase.Eip1559DefaultLegacyTransactions;
                ...
                ProperVerkleTransactionsSelectedTestCase baseFeeLowerThanGasPrice = ProperVerkleTransactionsSelectedTestCase.Eip1559DefaultLegacyTransactions;
                ...
                ProperVerkleTransactionsSelectedTestCase baseFeeGreaterThanGasPrice = ProperVerkleTransactionsSelectedTestCase.Eip1559DefaultLegacyTransactions;
                ...
                ProperVerkleTransactionsSelectedTestCase balanceCheckWithTxValue = new()
                {
                    Eip1559Enabled = true,
                    BaseFee = 5,
        ...
        public static IEnumerable Eip1559TestCases
        {
            get
            {
                ProperVerkleTransactionsSelectedTestCase allTransactionsSelected = ProperVerkleTransactionsSelectedTestCase.Eip1559Default;
                allTransactionsSelected.BaseFee = 0;
                allTransactionsSelected.ExpectedSelectedTransactions.AddRange(
                    allTransactionsSelected.Transactions.OrderBy(t => t.Nonce));
                yield return new TestCaseData(allTransactionsSelected).SetName("EIP1559 transactions: All transactions selected - 0 BaseFee");
                
                ProperVerkleTransactionsSelectedTestCase baseFeeLowerThanGasPrice = ProperVerkleTransactionsSelectedTestCase.Eip1559Default;
                baseFeeLowerThanGasPrice.BaseFee = 5;
                baseFeeLowerThanGasPrice.ExpectedSelectedTransactions.AddRange(
                    baseFeeLowerThanGasPrice.Transactions.OrderBy(t => t.Nonce));
                ...
                ProperVerkleTransactionsSelectedTestCase baseFeeGreaterThanGasPrice = ProperVerkleTransactionsSelectedTestCase.Eip1559Default;
                baseFeeGreaterThanGasPrice.BaseFee = 1.GWei();
                ...
                ProperVerkleTransactionsSelectedTestCase balanceCheckWithGasPremium = new()
                {
                    Eip1559Enabled = true,
                    BaseFee = 5,
                    AccountStates = {{TestItem.AddressA, (400, 1)}},
        ...
        [TestCaseSource(nameof(ProperVerkleTransactionsSelectedTestCases))]
        [TestCaseSource(nameof(Eip1559LegacyTransactionTestCases))]
        [TestCaseSource(nameof(Eip1559TestCases))]
        public void Proper_transactions_selected(ProperVerkleTransactionsSelectedTestCase testCase)
        {
            MemDb codeDb = new();
            VerkleStateProvider stateProvider = new(LimboLogs.Instance,codeDb);
    ...
    public class ProperVerkleTransactionsSelectedTestCase
    {
        ...
        public static ProperVerkleTransactionsSelectedTestCase Default =>
            new()
            {
        ...
        public static ProperVerkleTransactionsSelectedTestCase Eip1559DefaultLegacyTransactions =>
            new()
            {
                Eip1559Enabled = true,
                BaseFee = 1.GWei(),
        ...
        public static ProperVerkleTransactionsSelectedTestCase Eip1559Default =>
            new()
            {
                Eip1559Enabled = true,
                BaseFee = 1.GWei(),
