...
//     {
//     }
//     public VerklessTree(ILogManager? logManager)
...
//         _logger = logManager?.GetClassLogger<VerklessTree>() ?? throw new ArgumentNullException(nameof(logManager));
...
//     }
//
//     public VerklessTree(IVerkleTrieStore verkleTrieStore)
//         : this(verkleTrieStore, EmptyTreeHash, true, NullLogManager.Instance)
//     {
//     }
//     public VerklessTree(IVerkleTrieStore verkleTrieStore, ILogManager? logManager)
