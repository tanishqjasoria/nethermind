...
namespace Nethermind.Synchronization.Test
{
    ...
    public class VerkleSyncThreadsTests
    {
        ...
        public VerkleSyncThreadsTests(SynchronizerType synchronizerType)
        {
...
//            var logManager = new OneLoggerLogManager(logger);
            ...
            VerkleStateReader stateReader = new(trieStore, codeDb, logManager);
            VerkleStateProvider stateProvider = new(trieStore, logManager, codeDb);
            stateProvider.CreateAccount(TestItem.AddressA, 10000.Ether());
            stateProvider.Commit(specProvider.GenesisSpec);
            stateProvider.CommitTree(0);
            stateProvider.RecalculateStateRoot();

            VerkleStorageProvider storageProvider = new(stateProvider, logManager);
            ...
            VerkleStateProvider devState = new(trieStore, logManager, codeDb);
            VerkleStorageProvider devStorage = new(devState, logManager);
